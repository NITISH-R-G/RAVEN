...
import { NLPModelType } from './ModelControl';

interface ModelLogDetailsProps {
  selectedModel: NLPModelType;
}

export const ModelLogDetails: React.FC<ModelLogDetailsProps> = ({ selectedModel }) => {
  return (
      ...
      <div className="space-y-1">
        <p className="text-slate-300 font-mono text-[11px] font-semibold leading-none">
          {selectedModel === 'anthropic-finance' &&
            'Claude 3.5 Sonnet Financial Schema Handler (Aligned with anthropics/financial-services)'}
